...
application, document it in the [README](https://github.com/Comcast/libucresolv/blob/master/README.md) or [wiki](https://github.com/Comcast/libucresolv/wiki)! This includes new features, additional variants of behavior and breaking changes.
